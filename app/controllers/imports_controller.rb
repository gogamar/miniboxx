  ...
  def upload_products
    ...
    begin
      ...
      (2..spreadsheet.last_row).each do |i|
        ...
        product.sales_description_en = row['Sales Description']
        formatted_sales = product.sales_description_en.gsub("\n", "<br>")
        product.sales_description_en = formatted_sales
        product.quality_description_en = row['Quality Description']
        formatted_quality = product.quality_description_en.gsub("\n", "<br>")
        product.quality_description_en = formatted_quality
        ...
        product.wash_care_en = row["Wash and Care"]
        formatted_wash = product.wash_care_en.gsub("\n", "<br>")
        product.wash_care_en = formatted_wash
