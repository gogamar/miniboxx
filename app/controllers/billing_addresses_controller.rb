class BillingAddressesController < ApplicationController
  ...
  def update
    if @billing_address.update(billing_address_params)
      redirect_to @billing_address, notice: "Billing address was successfully updated.", status: :see_other
    else
  ...
  def destroy
    ...
    redirect_to billing_addresses_url, notice: "Billing address was successfully destroyed.", status: :see_other
  end
  ...
  private
    ...
    def billing_address_params
      params.require(:billing_address).permit(:name, :vat_number, :address_first, :address_second, :post_code, :city, :region, :country)
    end
end
