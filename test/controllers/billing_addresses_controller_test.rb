...
class BillingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing_address" do
    assert_difference("BillingAddress.count") do
      post billing_addresses_url, params: { billing_address: { address_first: @billing_address.address_first, address_second: @billing_address.address_second, city: @billing_address.city, country: @billing_address.country, name: @billing_address.name, post_code: @billing_address.post_code, region: @billing_address.region, vat_number: @billing_address.vat_number } }
    end
  ...
  test "should update billing_address" do
    patch billing_address_url(@billing_address), params: { billing_address: { address_first: @billing_address.address_first, address_second: @billing_address.address_second, city: @billing_address.city, country: @billing_address.country, name: @billing_address.name, post_code: @billing_address.post_code, region: @billing_address.region, vat_number: @billing_address.vat_number } }
