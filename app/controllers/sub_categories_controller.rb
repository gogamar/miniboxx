class SubCategoriesController < ApplicationController
  ...
  def update
    if @sub_category.update(sub_category_params)
      redirect_to @sub_category, notice: "Sub category was successfully updated.", status: :see_other
    else
  ...
  def destroy
    ...
    redirect_to sub_categories_url, notice: "Sub category was successfully destroyed.", status: :see_other
  end
