...
class ShippingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_address" do
    assert_difference("ShippingAddress.count") do
      post shipping_addresses_url, params: { shipping_address: { address_first: @shipping_address.address_first, address_second: @shipping_address.address_second, city: @shipping_address.city, country: @shipping_address.country, name: @shipping_address.name, phone_number: @shipping_address.phone_number, post_code: @shipping_address.post_code, region: @shipping_address.region } }
    end
  ...
  test "should update shipping_address" do
    patch shipping_address_url(@shipping_address), params: { shipping_address: { address_first: @shipping_address.address_first, address_second: @shipping_address.address_second, city: @shipping_address.city, country: @shipping_address.country, name: @shipping_address.name, phone_number: @shipping_address.phone_number, post_code: @shipping_address.post_code, region: @shipping_address.region } }
